...
/**
 * PulsarBatchFormatter formats a batch of change notification records into a
 * single Pulsar record.
 *
 * <p>
 ...
 * format:
 *   mode: custom
 *   class: com.aerospike.connect.outbound.transformer.examples.pulsar.PulsarBatchFormatter
 * </pre>
 */
public class PulsarBatchFormatter implements BatchFormatter<PulsarOutboundMetadata> {
    private final static Logger logger =
            LoggerFactory.getLogger(PulsarBatchFormatter.class.getName());

    private final static ObjectMapper objectMapper = new ObjectMapper();

    @Override
    public List<OutboundRecord<PulsarOutboundMetadata>> format(
            @NonNull List<BatchItem<PulsarOutboundMetadata>> batchItems)
            throws Exception {
        ...
        return Collections.singletonList(new DefaultTextOutboundRecord<>(
                ...
                new PulsarOutboundMetadata(null), Collections.emptySet()
        ));
    }
}
