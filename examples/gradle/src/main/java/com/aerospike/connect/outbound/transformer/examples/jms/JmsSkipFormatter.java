...
/**
 * JmsSkipFormatter skips record exceeding a configured generation number.
 *
 * <p>
 ...
 * format:
 *   mode: custom
 *   class: com.aerospike.connect.outbound.transformer.examples.jms.JmsSkipFormatter
 *   params:
 *     genNumber: 100
 *   payload-format:
 ...
 */
@Singleton
public class JmsSkipFormatter implements Formatter<JmsOutboundMetadata> {
    private final static Logger logger =
            LoggerFactory.getLogger(JmsSkipFormatter.class.getName());
    ...
    @Inject
    public JmsSkipFormatter(FormatterConfig routerConfig) {
