...
/**
 * EspRecordTransformer updates generation and adds bins passed in the config to
 ...
 * <pre>
 * custom-transformer:
 *   class: com.aerospike.connect.outbound.transformer.examples.esp.EspRecordTransformer
 *   params:
 *     bins:
 *       colour: RED
 *       shade: light
...
public class EspRecordTransformer implements Transformer {
    ...
    @Inject
    public EspRecordTransformer(TransformerConfig transformerConfig) {
