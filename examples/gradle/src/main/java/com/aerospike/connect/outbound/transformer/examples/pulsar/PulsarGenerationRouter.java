...
/**
 * PulsarGenerationRouter routes records by generation number.
 *
 * <p>
 ...
 * routing:
 *   mode: custom
 *   class: com.aerospike.connect.outbound.transformer.examples.pulsar.PulsarGenerationRouter
 *   params:
 *     genNumber: 100
 * </pre>
 */
...
public class PulsarGenerationRouter implements Router<String> {
    ...
    public OutboundRoute<String> getRoute(
        ...
        // "genNumber" is to be set in params option of the Pulsar routing
        // config.
