...
/**
 * KafkaSkipRouter skips records exceeding a configured generation number.
 *
 * <p>
 ...
 * routing:
 *   mode: custom
 *   class: com.aerospike.connect.outbound.transformer.examples.kafka.KafkaSkipRouter
 *   params:
 *     genNumber: 100
 * </pre>
 */
public class KafkaSkipRouter implements Router<String> {
    private final static Logger logger =
            LoggerFactory.getLogger(KafkaSkipRouter.class.getName());
