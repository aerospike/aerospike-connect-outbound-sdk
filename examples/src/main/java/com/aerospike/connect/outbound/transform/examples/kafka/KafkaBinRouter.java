 ...
 * routing:
 *   mode: custom
 *   class: com.aerospike.connect.outbound.transform.examples.kafka.KafkaBinRouter
 *   params:
 *     internal: true
 * </pre>
 */
public class KafkaBinRouter implements Router<String> {
    ...
    public OutboundRoute<String> getRoute(
        ...
        if (bins.containsKey("internal")) {
            ...
            return OutboundRoute.newKafkaRoute("internal");
        }

        logger.debug("Routing record {} to external", record.getKey());
        return OutboundRoute.newKafkaRoute("external");
    }
}
