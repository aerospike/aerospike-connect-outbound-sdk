 ...
 * routing:
 *   mode: custom
 *   class: com.aerospike.connect.outbound.transformer.examples.kafka.KafkaGenerationRouter
 *   params:
 *     genNumber: 100
 * </pre>
 */
@Singleton
public class KafkaGenerationRouter implements Router<String> {
    private final static Logger logger =
            LoggerFactory.getLogger(KafkaGenerationRouter.class.getName());
