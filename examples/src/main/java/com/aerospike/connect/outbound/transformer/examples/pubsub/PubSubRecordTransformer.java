...
/**
 * PubSubRecordTransformer updates generation and adds bins passed in the config
 ...
 * <pre>
 * custom-transformer:
 *   class: com.aerospike.connect.outbound.transformer.examples.pubsub.PubSubRecordTransformer
 *   params:
 *     bins:
 *       colour: RED
 *       shade: light
...
public class PubSubRecordTransformer implements Transformer {
    ...
    @Inject
    public PubSubRecordTransformer(TransformerConfig transformerConfig) {
