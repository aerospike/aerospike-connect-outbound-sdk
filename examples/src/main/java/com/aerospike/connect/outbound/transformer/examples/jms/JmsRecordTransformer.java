...
/**
 * JmsRecordTransformer updates generation and adds bins passed in the config to
 * the change notification record.
 *
 * <p>
 * A snippet of a config for this transformer can be
 * <pre>
 * custom-transformer:
 *   class: com.aerospike.connect.outbound.transformer.examples.jms.JmsRecordTransformer
 *   params:
 *     bins:
 *       colour: RED
 *       shade: light
...
public class JmsRecordTransformer implements Transformer {
    ...
    @Inject
    public JmsRecordTransformer(TransformerConfig transformerConfig) {
