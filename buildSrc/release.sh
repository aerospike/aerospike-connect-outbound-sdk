...
usage() {
  cat <<EOF
usage: bash release.sh --module aerospike-connect-outbound-sdk --version 1.1.0 --release-notes-file release-notes.md
...
./gradlew --stacktrace --no-daemon ":$module:vulnerabilityScan"
