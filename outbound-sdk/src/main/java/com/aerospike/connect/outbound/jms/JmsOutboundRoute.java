...
/**
 * Outbound route to a JMS destination.
 */
public class JmsOutboundRoute extends DefaultOutboundRoute<String> {
    public JmsOutboundRoute(@NonNull OutboundRouteType type,
